...
// Instrucción Uno
let productos = [
  { nombre: "Camiseta", id: 0,  precio: 15, stock: 10, class: "producto", tipoProducto: "ropa" },
  { nombre: "Pantalones", id: 1, precio: 25, stock: 8, class: "producto", tipoProducto: "ropa" },
  { nombre: "Zapatos", id: 2, precio: 50, stock: 5, class: "producto", tipoProducto: "ropa" },
  { nombre: "Sombrero", id: 3, precio: 10, stock: 20, class: "producto", tipoProducto: "ropa" },
  { nombre: "Linterna", id: 4, precio: 2, stock: 50, class: "producto", tipoProducto: "objetos" }
];
let carrito = [];
